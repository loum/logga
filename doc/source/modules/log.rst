...
Log - Logger
============
The :mod:`logga.log` module wraps the standard Python :mod:`logging`
...
One of the handiest features with :mod:`logga.log` is that it
...
Simply import the :mod:`logga.log` ``log`` handler object into your
project.


    .. note::

        Behind the scenes, the :mod:`logga.log` ``log`` handler object
...
Similarly, import the :mod:`logga.log` to your python module.
